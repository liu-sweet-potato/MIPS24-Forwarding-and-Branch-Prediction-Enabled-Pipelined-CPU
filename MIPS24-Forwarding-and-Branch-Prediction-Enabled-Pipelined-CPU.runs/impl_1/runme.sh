...
HD_PWD='C:/Projects/MIPS24-Forwarding-and-Branch-Prediction-Enabled-Pipelined-CPU/MIPS24-Forwarding-and-Branch-Prediction-Enabled-Pipelined-CPU.runs/impl_1'
cd "$HD_PWD"
